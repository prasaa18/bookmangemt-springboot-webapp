									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group">
												<from:input path="username" name="username" class="form-style" placeholder="Your Username" id="logemail" autocomplete="off"/>
												<i class="input-icon uil uil-at"></i>
											</div>	
											<div class="form-group mt-2">
												<form:input path="password" name="password" class="form-style" placeholder="Your Password" id="logpass" autocomplete="off"/>
