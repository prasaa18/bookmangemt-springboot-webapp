             ...
             <form action="/save" >
                 ...
                 <div class="row mb-3">
                   ...
                   <label class="col-sm-2 col-form-label"><strong>BOOK NAME</strong></label>
                     <div class="col-sm-10">
                      <input type="text" class="form-control" id="bookname" name="bookname" placeholder="Enter the name">
                        </div>
                     </div>
                   ...
                   <label class="col-sm-2 col-form-label"><strong>BOOK PRICE</strong></label>
                     <div class="col-sm-10">
                      <input type="text" class="form-control" id="bookprice" name="bookprice" placeholder="Enter the  price">
                        </div>
                   ...
                   <label class="col-sm-2 col-form-label"><strong>DISCRIPTION</strong></label>
                     <div class="col-sm-10">
                      <input type="text" class="form-control" id="discription" name="discription" placeholder="Enter the  discription">
                        </div>
